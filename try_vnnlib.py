...
def read_vnnlib_simple(vnnlib_filename, num_inputs, num_outputs):
    ...
    # example: "(assert (and (>= X_0 -2.391491746902466)(<= X_0 -2.1914917469024657)(>= X_1 -3.336046314239502)(<= X_1 -3.136046314239502)))"
    regex_and_assert = re.compile(r"^\(assert \(and (" + comparison_str + r")+\)\)$")
...
if __name__ == "__main__":
    num_inputs, num_outputs, x = get_num_inputs_outputs("./1.onnx")
    print(num_inputs)
    print(num_outputs)
    vnnlib_filename = "./1.vnnlib"
    print(read_vnnlib_simple(vnnlib_filename, num_inputs, num_outputs))